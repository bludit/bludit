...
class pluginGoogle extends Plugin {
        ...
        public function form()
        {
                ...
                $html .= '<div>';
                $html .= '<label>'.$Language->get('Google Tag Manager').'</label>';
                $html .= '<input type="text" name="google-tag-manager" value="'.$this->getDbField('google-tag-manager').'">';
        ...
        public function siteHead()
        {
                ...
                if( $this->getValue('google-tag-manager') ) {
                        $html .= PHP_EOL."<!-- Google Tag Manager -->";
